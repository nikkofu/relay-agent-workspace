...
import { Search, Filter, Users, Building, Clock, ChevronRight } from "lucide-react"
...
export default function PeopleDirectoryPage() {
  ...
  const { userGroups, fetchUserGroups } = useDirectoryStore()
    ...
    <div className="flex-1 flex flex-col bg-white dark:bg-[#1a1d21] h-full overflow-hidden">
      <header className="h-14 px-6 flex items-center border-b shrink-0 justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-black tracking-tight uppercase">People Directory</h1>
        </div>
      </header>
