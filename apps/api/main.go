...
func main() {
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.GET("/workspace/views", handlers.ListWorkspaceViews)
		...
		v1.GET("/ai/canvas/analysis-execution-history", handlers.GetAnalysisExecutionHistory)
		...
		v1.POST("/ai/canvas/generate-workflow-draft", handlers.GenerateWorkflowDraftFromAnalysis)
		v1.POST("/ai/canvas/confirm-create-workflow", handlers.ConfirmCreateWorkflowFromDraft)
		v1.POST("/ai/canvas/generate-message-draft", handlers.GenerateMessageDraftFromAnalysis)
		v1.POST("/ai/canvas/confirm-publish-message", handlers.ConfirmPublishMessageFromDraft)
