...
## Phase 0: 项目脚手架 & 基础设施
- [/] 使用 shadcn CLI 初始化 Next.js 项目
- [ ] 安装额外依赖（zustand, ai-sdk 等）
- [ ] 批量安装 shadcn/ui 核心组件
- [ ] 安装 shadcn.io/ai 组件
- [ ] 创建类型定义 (types/index.ts)
- [ ] 创建 Mock 数据 (lib/mock-data.ts)
- [ ] 创建 Zustand stores

## Phase 1: Slack 核心三栏布局
- [ ] 主导航栏 (primary-nav.tsx)
- [ ] 频道侧边栏 (channel-sidebar.tsx)
- [ ] 消息主区域 (message-area.tsx)
- [ ] 线程面板 (thread-panel.tsx)
- [ ] 工作区布局组装 (workspace/layout.tsx)
